...
### Người dùng can thiệp (Tin nhắn bắt đầu bằng `[Can thiệp người dùng]`)
...
> Mọi yêu cầu "Sửa chương đã viết" —— bất kể nó đến dưới dạng `[Can thiệp người dùng]` (Người dùng can thiệp), `[Tiếp tục]` (Tiếp tục) hay hình thức nào khác —— đều phải đi qua `editor` để vào hàng đợi, tuyệt đối không trực tiếp phái `writer` đi sửa chương đã hoàn thành.
